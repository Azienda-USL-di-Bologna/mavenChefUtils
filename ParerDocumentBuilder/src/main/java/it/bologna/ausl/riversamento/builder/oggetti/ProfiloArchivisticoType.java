 ...
 *       &lt;sequence>
 *         &lt;element name="FascicoloPrincipale" type="{}StrutturaFascicoloType"/>
 *         &lt;element name="FascicoliSecondari" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="FascicoloSecondario" type="{}StrutturaFascicoloType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class ProfiloArchivisticoType {
    ...
    protected StrutturaFascicoloType fascicoloPrincipale;
     ...
     * @return
     *     possible object is
     *     {@link StrutturaFascicoloType }
     *     
     */
    public StrutturaFascicoloType getFascicoloPrincipale() {
     ...
     *     
     */
    public void setFascicoloPrincipale(StrutturaFascicoloType value) {
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "FascicoliSecondari", propOrder = {
        "fascicoloSecondario"
    })
    public static class FascicoliSecondari {

        @XmlElement(name = "FascicoloSecondario", required = true)
        protected List<StrutturaFascicoloType> fascicoloSecondario;

        public void addFascicoloSecondario(StrutturaFascicoloType s){
            if (fascicoloSecondario == null) {
                fascicoloSecondario = new ArrayList<StrutturaFascicoloType>();
            }
            fascicoloSecondario.add(s);
        }
         ...
         * 
         */
        public List<StrutturaFascicoloType> getFascicoloSecondario() {
            if (fascicoloSecondario == null) {
                fascicoloSecondario = new ArrayList<StrutturaFascicoloType>();
            }
